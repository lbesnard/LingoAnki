...
class TprsCreation(DiaryHandler):
    def __init__(self):
        ...
        self.markdown_script_generated_tprs_all_path = os.path.join(
    ...
    def get_all_diary_titles(self):
        ...
        if os.path.exists(self.markdown_script_generated_diary_path):
    ...
    def add_missing_tprs(self):
        ...
        if os.path.exists(self.markdown_script_generated_diary_path):
            ...
            diary_path = self.markdown_diary_path
